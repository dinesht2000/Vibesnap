...
export default function CreatePost() {
  ...
  const { content, setContent, isUploading, handleCreatePost } =
    useCreatePost();
  ...
  const onCreatePost = async () => {
    ...
    await handleCreatePost(
      ...
      selectedFiles.length > 0
        ...
        : [],
      mediaType,
      previewUrls.length > 0 ? previewUrls : previewUrl ? [previewUrl] : []
    );
  };
          ...
          {(previewUrl || previewUrls.length > 0) && mediaType ? (
            <>
              ...
              <textarea
                ...
                className="w-full min-h-50 p-4 bg-gray-100 rounded-lg border-none outline-none resize-none text-black placeholder-gray-400 text-base mt-4"
